...
export const MovieHero = ({ movie }: { movie: MovieExtended }) => {
  ...
  return (
    <section className="relative flex flex-col justify-center w-full">
      <div className="z-1 flex pt-10 flex-col gap-2 items-center xl:items-start xl:flex-row">
        <div className="aspect-[2/3] w-40 sm:w-50 relative z-1 rounded-3xl overflow-hidden ring-1 ring-gray-700">
          <Image
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-center text-gray-200 text-2xl z-10 font-bold tracking-tight xl:text-4xl xl:text-left leading-8">
            {movie.title}
          </h1>
